...
**How to install:**
  ...
  *catkin_make*
  ...
  - The **stress_detection.py** python script runs separately on the VScode environment (you can use it in your favourite IDE). Please be aware that the python script has its library dependencies. You should install all of them before running the node.
